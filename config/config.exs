...
config :zypi,
  ...
  grpc_port: String.to_integer(System.get_env("ZYPI_GRPC_PORT", "4001")),
  console_port: String.to_integer(System.get_env("ZYPI_CONSOLE_PORT", "4002")),
  pool: [
    ip_subnet: {10, 0, 0, 0},
    ip_pool_size: 254
  ]
...
# gRPC protobuf code generation (protox — no protoc needed)
config :protox,
  schema_dir: "./proto",
  include_dirs: ["./proto"],
  schema_file: "zypi.proto"
